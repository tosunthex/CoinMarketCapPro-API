...
namespace CoinMarketCapPro_API.Clients
{
    public interface IExchangeClient
    {
        ...
        /// <param name="slug">Alternatively, one or more comma-separated exchange names in URL friendly shorthand "slug" format (all lowercase, spaces replaced with hyphens). Example: "binance,gdax". At least one "id" or "slug" is required</param>
        /// <returns></returns>
        ...
        /// This endpoint is available on the following API plans:Hobbyist,Standard,Professional,Enterprise
        /// </summary>
        /// <param name="listingStatus">Only active cryptocurrency exchanges are returned by default. Pass 'inactive' to get a list of exchanges that are no longer active.Default : "active"</param>
        /// <param name="slug">Optionally pass a comma-separated list of exchange slugs (lowercase URL friendly shorthand name with spaces replaced with dashes) to return CoinMarketCap IDs for. If this option is passed, other options will be ignored</param>
        ...
        /// <param name="start">Optionally offset the start (1-based index) of the paginated list of items to return Default:1 </param>
        /// <param name="limit">Optionally specify the number of results to return. Use this parameter and the "start" parameter to determine your own pagination size</param>
        /// <param name="sortField">What field to sort the list of exchanges by Valid Values: "name" , "volume_24h" Default:"date_added"</param>
        ...
        /// <param name="convert">Optionally calculate market quotes in up to 32 currencies at once by passing a comma-separated list of cryptocurrency or fiat currency symbols. Each additional convert option beyond the first requires an additional call credit. Each conversion is returned in its own "quote" object</param>
        /// <returns></returns>
        ...
        /// <param name="sortField">What field to sort the list of exchanges by Valid Values: "name" , "volume_24h" Default:"volume_24h"</param>
        /// <param name="sortDir">The direction in which to order exchanges against the specified sort Valid Values: "asc","desc"</param>
        /// <param name="marketType">The type of exchange markets to include in rankings Valid Values: "fees","no_fees","all"</param>
        /// <param name="convert">Optionally calculate market quotes in up to 32 currencies at once by passing a comma-separated list of cryptocurrency or fiat currency symbols. Each additional convert option beyond the first requires an additional call credit. Each conversion is returned in its own "quote" object</param>
        /// <returns></returns>
        ...
        /// <param name="slug">Alternatively pass an exchange "slug" (URL friendly all lowercase shorthand version of name with spaces replaced with hyphens). Example: "binance". One "id" or "slug" is required</param>
        /// <param name="start">Optionally offset the start (1-based index) of the paginated list of items to return Default: 1</param>
        /// <param name="limit">Optionally specify the number of results to return. Use this parameter and the "start" parameter to determine your own pagination size Default: 100</param>
        ...
        /// <param name="slug">Alternatively the exchange slug to return historical data for. The 'slug' is a URL friendly shorthand version (all lowercase, spaces replaced with hyphens) of the exchange name. One "id" or "slug" is required</param>
        ...
        /// <param name="slug">Alternatively, pass a comma-separated list of exchange "slugs" (URL friendly all lowercase shorthand version of name with spaces replaced with hyphens). Example: "binance,gdax". At least one "id" or "slug" is required</param>
        /// <param name="convert">Optionally calculate market quotes in up to 32 currencies at once by passing a comma-separated list of cryptocurrency or fiat currency symbols. Each additional convert option beyond the first requires an additional call credit.</param>
        /// <returns></returns>
